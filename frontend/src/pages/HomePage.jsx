...
import { ArrowRight, CheckCircle, XCircle, ChevronRight, ExternalLink, Star, ArrowUpRight, Plus, Minus } from 'lucide-react';
import { useLanguage } from '../contexts/LanguageContext';
import CalendlyButton from '../components/CalendlyButton';
import useScrollAnimation from '../hooks/useScrollAnimation';
import { client, getLatestPostsQuery } from '../lib/sanityClient';

const API = process.env.REACT_APP_BACKEND_URL;
const PORTRAIT = "https://customer-assets.emergentagent.com/job_immersive-automation/artifacts/4ayl7555_NZ_Matar_Portrait.24-38.jpg";
...
const SEOHead = ({ lang }) => (
  <Helmet>
    <html lang={lang} />
    <title>Matar Gueye — AI Strategist | Automazioni &amp; Esperienze 3D/AR/VR</title>
    <meta name="description" content="Sono Matar Gueye. Aiuto aziende a integrare l'AI nei processi, creare automazioni intelligenti e costruire esperienze 3D/AR/VR. Partner strategico, non fornitore." />
    <script type="application/ld+json">{JSON.stringify({
      "@context": "https://schema.org",
      "@type": "Person",
      "name": "Matar Gueye",
      "jobTitle": "AI Strategist & Immersive Tech Expert",
      "description": "AI Strategist, fondatore di EvolverAI. Aiuto aziende ad integrare l'AI nei processi aziendali.",
      "url": "https://matarai.com",
      "brand": { "@type": "Brand", "name": "Matar.AI" },
      "worksFor": { "@type": "Organization", "name": "EvolverAI" }
    })}</script>
  </Helmet>
);
          ...
          <div className="animate-fade-up delay-200 flex justify-center lg:justify-end">
            <div className="relative w-72 md:w-80 lg:w-[360px]">
              ...
              <div className="relative rounded-3xl overflow-hidden" style={{ border: '1px solid rgba(255,255,255,0.10)', boxShadow: '0 0 80px rgba(124,58,237,0.18)' }}>
                <img src={PORTRAIT} alt="Matar Gueye — AI Strategist" className="w-full object-cover object-top" style={{ aspectRatio: '3/4' }} />
        ...
        <div className="grid lg:grid-cols-5 gap-12 items-start">
          ...
          <div ref={leftRef} className="reveal-left lg:col-span-2">
            <div className="relative mb-8">
              <div className="w-full aspect-square max-w-xs mx-auto lg:mx-0 rounded-3xl overflow-hidden relative"
                style={{ border: '1px solid rgba(255,255,255,0.10)', boxShadow: '0 0 60px rgba(124,58,237,0.18)' }}>
                <img src="/portrait.jpg"
                  alt="Matar Gueye — AI Strategist" className="w-full h-full object-cover object-center" />
        ...
        <div className="grid md:grid-cols-3 gap-5">
          {(posts.length === 0 ? [1,2,3] : posts).map((post, i) => (
            posts.length === 0 ? (
              ...
              <a key={i} href={`/blog/${post.slug}`} data-testid={`blog-post-preview-${i}`}
  ...
  const submit = async (e) => {
    ...
    try {
      const res = await fetch('https://api.web3forms.com/submit', {
        ...
        body: JSON.stringify({
          access_key: 'b2a492c3-1fe6-4607-a8d2-f19af7de4840',
      ...
      if (data.success) { setStatus('success'); setForm({ name: '', email: '', company: '', service: '', message: '' }); }
