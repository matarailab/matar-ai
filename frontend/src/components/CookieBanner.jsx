...
const CookieBanner = () => {
  ...
  useEffect(() => {
    ...
    // Se ha già accettato, PostHog gira normalmente
    // Se ha rifiutato, disabilitiamo PostHog
    if (consent === 'declined') {
      disablePosthog();
    }
  }, []);
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <p className="text-sm text-slate-300 leading-relaxed">
            ...
            <Link to="/privacy" className="text-blue-400 hover:text-blue-300 underline" onClick={() => setVisible(false)}>
              Cookie Policy
            </Link>
            .
          </p>
