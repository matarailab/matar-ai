...
export const metadata = {
  title: 'Privacy Policy & Cookie Policy | Matar.AI',
  description: 'Informativa sulla privacy e sui cookie di Matar.AI, ai sensi del GDPR (Reg. UE 2016/679).',
  robots: 'noindex',
};

export default function PrivacyPolicyPage() {
  return (
    <div className="min-h-screen pt-24 pb-24 px-6 bg-[#050B1A]">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <h1 className="text-4xl font-bold text-white mb-3" style={{ fontFamily: "'Outfit', sans-serif" }}>Privacy Policy</h1>
        ...
        <div className="border-t border-white/10 pt-12 mb-12">
          <h1 className="text-4xl font-bold text-white mb-3" style={{ fontFamily: "'Outfit', sans-serif" }}>Cookie Policy</h1>
          <p className="text-slate-500 text-sm">Ultimo aggiornamento: aprile 2025</p>
        </div>
        ...
        <Section title="Cookie utilizzati da questo sito">
          <div className="space-y-6">
            ...
            <div className="rounded-xl p-5" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.07)' }}>
              <p className="text-white font-medium mb-1">Cookie di terze parti — Cal.com</p>
              <p>Utilizzati quando prenoti una consulenza tramite il widget Cal.com integrato nel sito.</p>
        ...
        <Section title="Come gestire i cookie">
          ...
          <p className="mt-3">Disabilitare i cookie potrebbe influir sul corretto funzionamento di alcune parti del sito.</p>
        </Section>
